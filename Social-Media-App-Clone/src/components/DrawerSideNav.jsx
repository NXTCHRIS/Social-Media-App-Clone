...
export default function DrawerSideNav({
  ...
  let classCluster = `menu bg-[rgba(13,17,20,255)] border-r border-slate-600 text-base-content min-h-full lg:w-52 p-4 fixed lg:sticky xl:fixed top-0 left-0 pt-20 ${drawerContentCss}`;
  return (
